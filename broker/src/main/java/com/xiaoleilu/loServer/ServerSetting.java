...
public class ServerSetting {
    ...
    static {
        ...
        getActionMap = new ConcurrentHashMap<>();
        postActionMap = new ConcurrentHashMap<>();

        putActionMap = new ConcurrentHashMap<>();

        deleteActionMap = new ConcurrentHashMap<>();

        errorActionMap = new ConcurrentHashMap<>();
